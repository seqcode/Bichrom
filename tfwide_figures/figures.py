...
def TFwide_embeddings(datapath, modelpath):
    ...
    protein_list = ['Ascl1', 'Ngn2', 'CDX2', 'BHLHB8', 'FOXA1', 'DUXBL', 'SOX15', 'SOX2', 'SIX6', 'DLX6', 'HLF', 'RHOX11']
    # protein_list = ['CDX2']
    ...
    for protein in protein_list:
        ...
        # Defining the model
        try:
            modelpath_curr = modelpath + protein + '.NIH3T3.chrom.adam.10.hdf5'
            print modelpath_curr
            model = load_model(modelpath_curr)
        except:
            modelpath_curr = modelpath + protein + '.ES.chrom.adam.05.hdf5'
            print modelpath_curr
            model = load_model(modelpath_curr)
    ...
    sns.boxplot(hue=dat['chromatin'], y=dat['score'], x=dat['protein'], palette='BrBG')
